...
4. Executáveis Go compilados localmente para os clientes
"""
...
class ExecutorTesteGo:
    ...
    def _verificar_prerrequisitos(self):
        ...
        # 3. Verificar se o executável Go existe
    ...
    def executar_cliente_go(self, num_clientes, num_mensagens):
        """Executar múltiplos clientes Go em paralelo"""
        threads = []
    ...
    def executar_teste_completo(self):
        ...
        print("🚀 Iniciando execução de testes Go com Kubernetes")
    ...
    def _exibir_resumo_final(self):
        ...
        print("\n" + "=" * 80)
        print("📊 RESUMO FINAL DOS TESTES GO")
        print("=" * 80)
